...
export function UnlockVaultPage({ vaultName, onUnlock, onBack }: UnlockVaultPageProps) {
  ...
  // FIX: The type of `vaultData.recoveryMethod` is `'code' | 'questions' | undefined`.
  // It can never be 'none', so the check `vaultData.recoveryMethod !== 'none'` is redundant and causes a type error.
